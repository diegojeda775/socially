...
function PostCard(props: { post: Post; dbUserId: string; user: User}) {
  const {post, dbUserId, user} = props;
  ...
  const isBusy = useMemo(() => isCommenting || isLiking || isDeleting, [isCommenting, isLiking, isDeleting]);
          ...
          <div className="flex space-x-3 sm:space-x-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between">
                ...
                {/* delete if current use is author */}
                {dbUserId === post.author.id && (
                  <AlertDialogPopUp 
                    isBusy={isBusy} 
                    onClickFn={handleDeletePost} 
                    title="Delete Post" 
